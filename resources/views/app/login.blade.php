...
<main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                ...
                @endif
                @if(Session::has('signin-failed'))
                <div class="alert alert-danger" role="alert">
                {{Session::get('signin-failed')}}
                </div>
                @endif
                <div class="row justify-content-center form-bg-image" data-background-lg="../../assets/img/illustrations/signin.svg">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form id="loginForm" method="POST" action="{{route('signinUser')}}" class="mt-4">
                                <!-- Form -->
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex justify-content-between align-items-top mb-4">
                                        ...
                                        <div><a href="/lost-password" class="small text-right">Lost password?</a></div>
                                    </div>
                                </div>
                                <div class="d-grid">
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    Not registered?
                                    <a href="/user-signup" class="fw-bold">Create account</a>
                                </span>
                            </div>
                        </div>
                    </div>
